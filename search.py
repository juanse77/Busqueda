...
def busqueda_ramificacion_acotada(problem):
    """Busqueda por ramificacion y acotacion"""
    return graph_search(problem, ListaCostes())

def busqueda_ramificacion_acotada_subestimada(problem):
    """Busqeda por ramificacion y acotacion subestimada"""
    return graph_search(problem, ListaCostesSubestimados(problem))
